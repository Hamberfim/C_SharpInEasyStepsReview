...
namespace _06_FixingConstants
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach(int item in dayValues)  // var will result in the string name of the week days, int forces the use of a built-in enum method to return the index position
            {
